...
#--------------------------------------------------------------------------------------------#
 ...
 #===========================================================================================#
 #===========================================================================================#
 #============ Entering to the time step loop for the base microstructure ===================#
 #===========================================================================================#
 #===========================================================================================#
 #===========================================================================================#
 #===========================================================================================#
...
#----------------------------------------------------------------------------------
            ...
            iconv = 0
            ratio_norm = 1.0e10
            while (iconv <= nconv and abs(ratio_norm) >= 1.0e-4):
...
#------------------- Calculate matrix [A] 
                        A_mat = calc_ABC.calc_A(F_tau,Fp_t)
...
#                        print U1[3]
                        ...
                        # print(U1[1][1][1], U1[2][1][1], F_tau[1][1])
#####################     U1[0]=Fe_tau, U1[1]=Fp_tau, U1[2]=Cauchy, U1[3]=res_ssd, U1[5]=dgam , U1[6]=dgam_dta
                        mg = array(ielem.index,ig,U1[2],F_tau,U1[1],U2,U1[3],U1[5],U1[6],U1[7])
...
########## Check for L2 norm of unb_nod for convergence ##############
            ...
            for iel in range(nelem):
                Fp_list_el = []
                for ig in range(ngauss):
                    Fp_list_el.append(garray_tau[iel][ig].pdefg)
                Fp_list.append(Fp_list_el)

            for iel in range(nelem):
                F_list_el = []
                for ig in range(ngauss):
                    F_list_el.append(garray_tau[iel][ig].defg)
                F_list.append(F_list_el)

            for iel in range(nelem):
                Cauchy_stress_el_i = []
                for ig in range(ngauss):
                    Cauchy_stress_el_i.append(garray_tau[iel][ig].cauchy)
                Cauchy_stress_i.append(Cauchy_stress_el_i)
        ...
        # print(np.array(garray_list).shape)
        # print(garray_list)
        return strnvol,strsvol,gdisp,Cauchy_stress,Fp_list,F_list,gstiff,garray_list,Cauchy_stress_i
